    ...
    .container
        .flex.text-center
            .flex.px-3.py-4
                .text-center
                    div(
                        style='font-size: 32px; font-weight: 700; font-family: nunito'
                    ) Kini kamu bisa mendapatkan LUMÉCOLORS di Area-mu

            .flex.px-3.pb-4
                .text-center.nunito(
                    style='font-size: 16px; line-height: 1.8rem'
        ...
        .flex.px-3.pb-4.nunito(
            style='font-size: 16px; line-height: 1.8rem; font-weight: 700'
        )
            .flex
                .text-center.nunito(style='font-size: 24px; font-weight: 900')
                    span Cara Pesan via Agen Stockist kami:
            .flex.pt-3
                .text-center 1. Pilih area terdekat dengan alamat Anda
                .text-center 2. Klik Pesan via WhatsApp untuk konsultasi atau pembelian
            ...
            b-button(
                ...
                .flex.d-flex
                    .flex.d-flex
                        ...
                        .pt-1.pl-2(style='font-weight: 600') {{ p._id }}
            b-collapse(:visible='p.show')
                .flex.mb-1.mt-3(
                    ...
                    .flex.mt-2
                        ...
                        .flex
                            .flex.d-flex.px-3(v-if='a.online_store.shopee')
                                div(style='padding-top: 3px')
                                    img(
                                        width='16px',
                                        height='16px',
                                ...
                                .flex
                                    b-link(
                                        ...
                                        .pt-1.pl-2 {{ a.online_store.shopee.replace("https://shopee.co.id/", "") }}
                                            // i.mdi.mdi-check-bold.text-success.ml-2
                            .flex.d-flex.px-3(v-if='a.online_store.tokopedia')
                                div(style='padding-top: 3px')
                                    img(
                                        width='16px',
                                        height='16px',
                                ...
                                .flex
                                    b-link(
                                        ...
                                        .pt-1.pl-2 {{ a.online_store.tokopedia.replace("https://tokopedia.com/", "").replace("https://www.tokopedia.com/", "") }}
                                            // i.mdi.mdi-check-bold.text-success.ml-2
                            .flex.d-flex.px-3(v-if='a.online_store.lazada')
                                div(style='padding-top: 3px')
                                    img(
                                        width='16px',
                                        height='16px',
                                ...
                                .flex
                                    b-link(
                                        ...
                                        .pt-1.pl-2 {{ a.online_store.lazada.replace("https://lazada.co.id/shop/", "").replace("https://www.lazada.co.id/shop/", "") }}
                                            //   i.mdi.mdi-check-bold.text-success.ml-2
                            .flex.d-flex.px-3(v-if='a.online_store.bukalapak')
                                div(style='padding-top: 3px')
                                    img(
                                        width='16px',
                                        height='16px',
            ...
            .w-md
                .flex.d-flex.justify-content-center
                    b-button.text-white(
                        v-b-modal.WAPusat,
                        size='md',
                        style='background: #ea4335; border: solid 1px #ea4335'
                    ) Beli di Pusat
        .flex
            .py-5
                .row
                        ...
                        .flex.text-center
                            ...
                            .flex.d-flex.justify-content-center
                                b-button(
                                    href='https://www.tokopedia.com/search?navsource=home&ob=23&st=product&q=lumecolors',
                                    target='_blank',
                                    style='border: solid 1px #51b556; background: #51b556; color: #fff; font-size: 1.3rem'
                                ) Beli di Tokopedia
                    .col-lg-6.col-md-6.col-sm-6.col-xs-6
                        .flex
                            .flex.d-flex.justify-content-center
                            ...
                            .flex.d-flex.justify-content-center
                                b-button(
                                    href='https://shopee.co.id/search?keyword=lumecolors',
                                    target='_blank',
                                    style='border: solid 1px #ff4c3b; background: #ff4c3b; color: #fff; font-size: 1.3rem'
                                ) Beli di Shopee
...
export default {
    ...
    setup(props, context) {
        ...
        useFetch(() => {
            $axios.get('v1/future/agenaktif' + route.value.path).then((r) => {
                r.data.results.map((r) => {
                    r.show = false
                })
